public class Enemy {
    ...
    public void moveChoose(){
        ...
        while(isMovin==true){
            ...
            else if(KeyBox.map.whatMap()[r][c+1] == 'o' || KeyBox.map.whatMap()[r][c-1] == 'o' || KeyBox.map.whatMap()[r-1][c] == 'o' || KeyBox.map.whatMap()[r+1][c] == 'o' || KeyBox.map.whatMap()[r][c+1] == 'x' || KeyBox.map.whatMap()[r][c-1] == 'x' || KeyBox.map.whatMap()[r-1][c] == 'x' || KeyBox.map.whatMap()[r+1][c] == 'x' || KeyBox.map.whatMap()[r][c+1] == 'w' || KeyBox.map.whatMap()[r][c-1] == 'w' || KeyBox.map.whatMap()[r-1][c] == 'w' || KeyBox.map.whatMap()[r+1][c] == 'w' || KeyBox.map.whatMap()[r][c+1] == 's' || KeyBox.map.whatMap()[r][c-1] == 's' || KeyBox.map.whatMap()[r-1][c] == 's' || KeyBox.map.whatMap()[r+1][c] == 's') {
