public class Enemy {
    ...
    public void moveChoose(){
        ...
        while(isMovin==true){
            ...
            else if((KeyBox.map.whatMap()[r][c+1] == 'b' || KeyBox.map.whatMap()[r][c+1] == 'r') && (KeyBox.map.whatMap()[r][c-1] == 'b' || KeyBox.map.whatMap()[r][c-1] == 'r') && (KeyBox.map.whatMap()[r-1][c] == 'r' || KeyBox.map.whatMap()[r-1][c] == 'b') && (KeyBox.map.whatMap()[r+1][c] == 'b' || KeyBox.map.whatMap()[r+1][c] == 'r')){
                isMovin=false;
            }
        }
    }
